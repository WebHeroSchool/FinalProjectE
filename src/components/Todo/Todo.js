...
const Todo = () => {
  ...
  const [completedItems, setCompletedItems] = useState(items.filter((item) => item.isDone === true))
  const [uncompletedItems, setUncompletedItems] = useState(items.filter((item) => item.isDone === false))
